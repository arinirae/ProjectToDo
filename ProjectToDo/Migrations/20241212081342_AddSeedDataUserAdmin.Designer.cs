...
namespace ProjectToDo.Migrations
{
    ...
    [Migration("20241212081342_AddSeedDataUserAdmin")]
    partial class AddSeedDataUserAdmin
    {
            ...
            modelBuilder.Entity("ProjectToDo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Admin",
                            Password = "AQAAAAEAACcQAAAAEHR3oI+PVbeBtRJRHk8aCBBPU/wolKQLhDxmpW+1h64ytrF02fHY7UGEiZHpEZSZiw==",
                            RoleId = 4,
                            Username = "admin"
                        });
                });
